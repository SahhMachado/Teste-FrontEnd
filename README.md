# Sobre o Projeto
O projeto trata-se de um teste em react para a vaga de Desenvolvedor FrontEnd na Magazord, seguindo os padrões e modelo definidos.
Basicamente é uma tela que traz informações de perfil e repositórios do GitHub do usuário pesquisado.
